...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dhidden, grads['W3'], grads['b3'] = affine_backward(dscores, cache[3])
        dhidden, grads['W2'], grads['b2'] = affine_relu_backward(dhidden, cache[2])
        dhidden, grads['W1'], grads['b1'] = conv_relu_pool_backward(dhidden,cache[1])
